...
class Corso(db.Model):
    ...
    # Costruttore
    def __init__(self, nome, insegnante, livello, descrizione, logo_img="", stato_corso=StatoCorso.IN_PREVISIONE.value, link_materiale=""):
        self.nome = nome
    ...
    def insert_test_corsi():
        ...
        corsi = [ 
            ( "Flask", "Andrea Guzzo e Mario Nardi", LivelloCorso.INTERMEDIO.value, "Corso sul microframework Flask", "flask-icon.png", StatoCorso.IN_CORSO.value, "https://github.com/PythonGroupBiella/MaterialeLezioni/tree/master/Flask" ),
            ( "Pygame", "Mario Nardi", LivelloCorso.FACILE.value, "Introduzione a Pygame", "pygame-icon.png", StatoCorso.IN_PREVISIONE.value ),
            ( "Pandas", "Maria Teresa Panunzio", LivelloCorso.INTERMEDIO.value, "Corso base per manipolare i dataframes", StatoCorso.IN_PREVISIONE.value )
        ]
