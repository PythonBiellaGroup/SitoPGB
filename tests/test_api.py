...
class APITestCase(unittest.TestCase):
    ...
    def test_bad_auth(self):
        ...
        u = Utente(email='john@example.com', password='cat', confirmed=True,
                 ruolo=r)
        db.session.add(u)
        db.session.commit()
    ...
    def test_unconfirmed_account(self):
        ...
        r = Ruolo.query.filter_by(name='Utente').first()
        self.assertIsNotNone(r)
        u = Utente(email='john@example.com', password='cat', confirmed=False,
                 ruolo=r)
        db.session.add(u)
        db.session.commit()
    ...
    def test_users(self):
        ...
        r = Ruolo.query.filter_by(name='Utente').first()
        self.assertIsNotNone(r)
        u1 = Utente(email='john@example.com', username='john',
                  password='cat', confirmed=True, ruolo=r)
        u2 = Utente(email='susan@example.com', username='susan',
                  password='dog', confirmed=True, ruolo=r)
